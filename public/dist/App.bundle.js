...
function typeAhead(search) {
  ...
  var searchResults = _dompurify2.default.sanitize(search.querySelector('.search__results'));
  ...
  searchInput.on('input', function () {
    ...
    _axios2.default.get('/api/search?q=' + this.value).then(function (res) {
      if (res.data.length) {
        return searchResults.innerHTML = _dompurify2.default.sanitize(searchResultsHTML(res.data));
      }
